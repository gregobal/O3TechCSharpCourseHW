...
public static class ServiceCollectionExtensions
{
    ...
    private static void AddRedisRepositories(IServiceCollection services)
    {
        ...
        services.AddSingleton<IRateLimiterRepository, RateLimiterRedisRepository>();
    }
        ...
        IConfigurationRoot config)
    {
        ...
        services.Configure<RateLimiterRedisOptions>(config.GetSection(nameof(RateLimiterRedisOptions)));
